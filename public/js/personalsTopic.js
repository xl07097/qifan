...
$(function(){
    ...
    $(".topicDelete").click(function(){
        var item = $(this).parents(".topicList");
        swal({
                title: "确定删除吗",
                type: "warning",
    ...
    // function add() {
    //     var num = 8;//每页显示的个数
    //     var cooksNum = $('.item').length;//家常菜的总量
