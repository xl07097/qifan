            ...
            success:function (data) {
                ...
                $('.collVideo').click(function () {
                    ...
                    video.forEach(function (item) {
                        ...
                        var itemImg = $('<img>');
                        itemImg.attr('src','/images/'+item.video_img);
                        itemA.append(itemImg);
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                function addFocus() {
                    ...
                    // var focusUser = $("<div class='focusUser'></div>");
                    var focusUl = $('<ul class="focusUl"></ul>');
                    var focusLi = $('<li class="focusUser focusLi fL">关注'+ data[1][0].user_name +'的人（'+ data[1].length+'）</li>');
                    var focusedLi = $('<li class="focusedUser focusedLi fL">'+ data[1][0].user_name+'关注的人（'+ data[0].length+ '）</li>');
